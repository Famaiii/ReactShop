...
function App() {
    ...
    React.useEffect(() => {
        axios.get('https://630139989a1035c7f8ffc778.mockapi.io/items').then(res => {
            setItems(res.data)
        });
        // получаем данные которые были в корзине
        axios.get('https://630139989a1035c7f8ffc778.mockapi.io/cart').then(res => {
            setCartItems(res.data);
        });
        axios.get('https://630139989a1035c7f8ffc778.mockapi.io/favorites').then(res => {
